...
<body>
  ...
  <a href="main.jsp" id="logo">&nbsp;&nbsp;&nbsp;&nbsp;L&S Company</a>
	...
	<form action="userLoginAction.jsp" name="login" method="post">
	<fieldset style = "position:relative; left:800px; top:300px;width:330px; height:380px;opacity:0.8; ">
	<legend>LOGIN</legend>
		<div class="inputbox">
		<div style="opacity:0.7;">&nbsp;Your Id</div><br>
			<label title="아이디" class="id"></label>
				<input class="inputText" name="id" id="member_id" type="text" placeholder="아이디"><br><br>
		</div>
		<div class="inputbox">
		<div style="opacity:0.7;">&nbsp;Your Password</div><br>
				<label title="비밀번호" class="pw"></label>
					<input class="inputText"name="pw" id="member_pw" type="password" placeholder="비밀번호"><br>
		</div>
			<input title="로그인" href="main.jsp" class="btn_login" type="submit" value="LOGIN">
	</fieldset>
	</form>
	<form action="join.jsp" name="join" method="post">
			<input title="회원가입" href="join.jsp" class="btn_login" type="submit" value="JOIN"style="postion:absolute;top:220px;left:835px;opacity:0.8;">
	</form>
