...
<!-- 상품목록 -->
			<a href="fruitM1.jsp" style="position:relative;width:600px;">
					<img src="./img/fruit/fruitM1.JPG" style="position:relative; z-index:1;top:400px;left:550px;">
...
<form name="form" action="cartAction.jsp" method="get">
	...
	<legend>상품옵션</legend>
	<!-- -->
	상품명 : 할머니 공주 알밤 막걸리 <br></p> <input type="hidden" name="product" value="gongju">
