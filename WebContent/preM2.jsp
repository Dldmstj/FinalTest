...
<!-- 상품목록 -->
			<a href="preM2.jsp" style="position:relative;width:600px;">
					<img src="./img/premium/preM2.JPG" style="position:relative; z-index:1;top:400px;left:550px;">
...
<form name="form" action="cartAction.jsp" method="get">
	...
	<legend>상품옵션</legend>
	<!-- -->
	상품명 : 술 취한 원숭이 <br></p> <input type="hidden" name="product" value="drunkmonkey">
	수량 : <input type=hidden name="sell_price" value="2200">
