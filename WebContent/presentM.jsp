...
<link rel="stylesheet" type="text/css" href="css/presentM.css">
</head>
...
<div class="rice" style="position:absolute;top:270px;left:450px;color:orange;">
	<h2>약주, 증류주</h2>
	<hr align="center" style="border: solid 0.8px orange;width:1000px;position:absolute;top:50px;">
</div>
...
<ul class="imglist_ul" style="position:relative;top:400px;left:-40px;">
		<li>
			...
			<h3 style="text-align:center;">부자 1호 선물세트</h3><br>
				<div class="screen">
					<span></span><span></span><span></span><span></span>
					<img src="./img/present/buja1.png">
				</div>
				<!-- <p>불린 쌀과 밀가루에 물을 넣고 쑨 죽에 누룩을 섞어 항아리에 담아 7∼14일 발효시키고 용수를 박아 떠 낸 술의 찌꺼기에 물을 섞어 걸러낸 술입니다.</p>-->
			</a>
		</li>
		<li>
			<a href="sansam.jsp"style="position:relative;left:300px;width:600px;">
			<h3 style="text-align:center;">산양산삼 명술</h3><br>
				<div class="screen">
					<span></span><span></span><span></span><span></span>
					<img src="./img/present/sansam.jpg">
				</div>
			
			</a>
		</li><br><br>
		<li>
			<a href="pre.jsp" style="position:relative;top:60px;width:600px;">
			<h3 style="text-align:center;">부자 2병 세트</h3><br>
				<div class="screen">
					<span></span><span></span><span></span><span></span>
					<img src="./img/present/buja2.png">
				</div>
