...
<link rel="stylesheet" type="text/css" href="css/preM.css">
</head>
...
<div class="rice" style="position:absolute;top:270px;left:450px;color:red;">
	<h2>프리미엄 막걸리</h2>
	<hr align="center" style="border: solid 0.8px red;width:1000px;position:absolute;top:50px;">
</div>
...
<ul class="imglist_ul" style="position:relative;top:400px;left:-40px;">
		<li>
			<a href="preM1.jsp" style="position:relative;width:600px;">
			<h3 style="text-align:center;">부자 10도 막걸리</h3><br>
				<div class="screen">
					<span></span><span></span><span></span><span></span>
					<img src="./img/premium/buja10.png">
				</div>
				<!-- <p>불린 쌀과 밀가루에 물을 넣고 쑨 죽에 누룩을 섞어 항아리에 담아 7∼14일 발효시키고 용수를 박아 떠 낸 술의 찌꺼기에 물을 섞어 걸러낸 술입니다.</p>-->
			</a>
		</li>
		<li>
			<a href="preM2.jsp" style="position:relative;left:300px;width:600px;">
			<h3 style="text-align:center;">술 취한 원숭이</h3><br>
				<div class="screen">
					<span></span><span></span><span></span><span></span>
					<img src="./img/premium/drunkmonkey.png">
				</div>
	
			</a>
		</li><br><br>
		<li>
			<a href="preM3.jsp"style="position:relative;top:60px;width:600px;">
			<h3 style="text-align:center;">붉은 원숭이</h3><br>
				<div class="screen">
					<span></span><span></span><span></span><span></span>
					<img src="./img/premium/redmonkey.png">
				</div>
			
			</a>
		</li>
		<li>
			<a href="preM4.jsp" style="position:relative;top:60px;left:300px;width:600px;">
			<h3 style="text-align:center;">우곡생주</h3><br>
				<div class="screen">
					<span></span><span></span><span></span><span></span>
					<img src="./img/premium/ukok.png">
				</div>
