...
<link rel="stylesheet" type="text/css" href="css/riceM.css">
</head>
...
<!-- 상품목록 -->
			<a href="riceM1.jsp" style="position:relative;width:600px;">
					<img src="./img/rice/riceM1.JPG" style="position:relative; z-index:1;top:400px;left:550px;">
...
<form name="form" action="cartAction.jsp" method="get">
	...
	<legend>상품옵션</legend>
	<!-- -->
	상품명 : 부자 생 막걸리 <br></p> <input type="hidden" name="product" value="buja">
	수량 : <input type=hidden name="sell_price" value="1750">
