...
<!-- 상품목록 -->
			<a href="preM1.jsp" style="position:relative;width:600px;">
					<img src="./img/premium/preM1.JPG" style="position:relative; z-index:1;top:400px;left:550px;">
...
<form name="form" action="cartAction.jsp" method="get">
	<fieldset style = "position:relative; left:900px; bottom:30px;width:330px; height:380px;opacity:0.8; ">
	<br><br>
        <b><font size="6" color="gray">상품 정보</font></b>
	<legend>상품옵션</legend>
	<!-- -->
	상품명 : 부자 10도 막걸리 <br></p> <input type="hidden" name="product" value="buja10">
	수량 : <input type=hidden name="sell_price" value="2050">
