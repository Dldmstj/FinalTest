...
<!-- 상품목록 -->
			<a href="preM4.jsp" style="position:relative;width:600px;">
					<img src="./img/premium/preM4.JPG" style="position:relative; z-index:1;top:400px;left:550px;">
...
<form name="form" action="cartAction.jsp" method="get">
	...
	<legend>상품옵션</legend>
	<!-- -->
	상품명 : 우곡생주 <br></p> <input type="hidden" name="product" value="ukok">
