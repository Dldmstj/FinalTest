...
<!-- 상품목록 -->
			<a href="fruitM4.jsp" style="position:relative;width:600px;">
					<img src="./img/fruit/fruitM4.JPG" style="position:relative; z-index:1;top:400px;left:550px;">
...
<form name="form" action="cartAction.jsp" method="get">
	...
	<legend>상품옵션</legend>
	<!-- -->
	상품명 : 제주 우도 땅콩 막걸리 <br></p> <input type="hidden" name="product" value="udo">
	수량 : <input type=hidden name="sell_price" value="1550">
