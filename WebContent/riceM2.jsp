...
<!-- 상품목록 -->
			<a href="riceM2.jsp" style="position:relative;width:600px;">
					<img src="./img/rice/riceM2.JPG" style="position:relative; z-index:1;top:400px;left:550px;">
...
<form name="form" action="cartAction.jsp" method="get">
	...
	<legend>상품옵션</legend>
	<!-- -->
	상품명 : 덕산 쌀 막걸리 <br></p> <input type="hidden" name="product" value="ducksan">
